...
tak wywnioskowane, żeby "skasować" deklarator referencji; a druga nie
pasuje, bo przyjmuje przez referencję niestałą: `T` nie może być tak
wywnioskowane, żeby "skasować" kwalifikator `const`.
